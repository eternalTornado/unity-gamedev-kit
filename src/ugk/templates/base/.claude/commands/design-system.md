...
The GDD is the **feature spec** consumed by speckit in Phase 4 — it must be implementation-actionable. Mood/tone/creative framing belongs in `Design/GDD/game-concept.md`, not here.
